    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain_account', models.CharField(blank=True, max_length=50, verbose_name='Учетная запись')),
                ...
                ('location', models.CharField(blank=True, max_length=50, verbose_name='Кабинет')),
